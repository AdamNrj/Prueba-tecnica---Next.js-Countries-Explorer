...
export default function HomePage() {
  ...
  const { paginatedCountries, loading, error, currentPage, totalPages, setPage, countries } =
    useCountryContext();

  return (
    <>
      <Head>
        <title>Country Explorer | Discover Countries Around the World</title>
        <meta
          name="description"
          content="Browse and explore countries around the world with Country Explorer. Search by name, view details and more."
        />
        <meta property="og:title" content="Country Explorer" />
        <meta
          property="og:description"
          content="Browse and explore countries around the world with Country Explorer."
        />
            ...
            <section className="mt-12">
              <div className="flex items-center justify-between mb-8">
                ...
                <div className="text-sm text-gray-500 dark:text-gray-400 font-medium">
                  {loading ? t("loading") : `${countries.length} ${t("countriesFound")}`}
                </div>
              </div>
